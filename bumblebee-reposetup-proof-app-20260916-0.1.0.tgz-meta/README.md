[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/bumblebee-reposetup-proof-app-20260916/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/bumblebee-reposetup-proof-app-20260916/tree/main)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/giantswarm/bumblebee-reposetup-proof-app-20260916/badge)](https://securityscorecards.dev/viewer/?uri=github.com/giantswarm/bumblebee-reposetup-proof-app-20260916)
...
|---|---|---|
| `bumblebee-reposetup-proof-app-20260916` | the chart directory `helm/bumblebee-reposetup-proof-app-20260916`, `Chart.yaml`, `values.yaml`, `.abs/main.yaml`, `CHANGELOG.md`, this README | the repository name |
...
| `https://github.com/giantswarm/bumblebee-reposetup-proof-app-20260916` | this README | the upstream Helm repository the chart is based on |
...
# bumblebee-reposetup-proof-app-20260916 chart

Giant Swarm offers a bumblebee-reposetup-proof-app-20260916 App which can be installed in workload clusters.
Here, we define the bumblebee-reposetup-proof-app-20260916 chart with its templates and default configuration.
...
- https://github.com/giantswarm/bumblebee-reposetup-proof-app-20260916
