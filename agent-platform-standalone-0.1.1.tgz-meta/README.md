...
Giant Swarm offers a agent-platform-standalone App which can be installed in workload clusters.
Here, we define the agent-platform-standalone chart with its templates and default configuration.
