[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/bumblebee-accept-devctl-20260917/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/bumblebee-accept-devctl-20260917/tree/main)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/giantswarm/bumblebee-accept-devctl-20260917/badge)](https://securityscorecards.dev/viewer/?uri=github.com/giantswarm/bumblebee-accept-devctl-20260917)
...
|---|---|---|
| `bumblebee-accept-devctl-20260917` | the chart directory `helm/bumblebee-accept-devctl-20260917`, `Chart.yaml`, `values.yaml`, `.abs/main.yaml`, `CHANGELOG.md`, this README | the repository name |
...
| `https://github.com/giantswarm/bumblebee-accept-devctl-20260917` | this README | the upstream Helm repository the chart is based on |
...
# bumblebee-accept-devctl-20260917 chart

Giant Swarm offers a bumblebee-accept-devctl-20260917 App which can be installed in workload clusters.
Here, we define the bumblebee-accept-devctl-20260917 chart with its templates and default configuration.
...
- https://github.com/giantswarm/bumblebee-accept-devctl-20260917
